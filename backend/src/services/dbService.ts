...
import { FoodRetailerModel, StudySpaceModel, HealthClinicModel } from '../models';
...
export const connectDatabase = async (): Promise<void> => {
  try {
    if (URI) {
      ...
      throw new Error('No MongoDB URI defined and not in development mode. Please check environment variables.');
    }
  } catch (error) {
